...
public class MainActivity extends AppCompatActivity {
    ...
    private String searchString2="서울";
    private String searchString3="서울";
    private String lan1,lan2,lan3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lan1 = getString(R.string.travel_info);
        lan2 = getString(R.string.hotel_info);
        lan3 =  getString(R.string.event_info);
        tabs.addTab(tabs.newTab().setText(lan1));
        tabs.addTab(tabs.newTab().setText(lan2));
        tabs.addTab(tabs.newTab().setText(lan3));
    ...
    private void search() {
        if (frag_status=="2")
        {
            searchString = editText.getEditableText().toString();
            Fragment_hotel_info.getInstance().search();
        }
        if (frag_status=="1")
        {
            searchString2 = editText.getEditableText().toString();
            Fragment_travel_main.getInstance().search();
        }
        if (frag_status=="3")
        {
            searchString3 = editText.getEditableText().toString();
    ...
    public String publicMethod() { return searchString; }
    public String publicMethod2() { return searchString2; }
    public String publicMethod3() { return searchString3; }
    public String publicMethod4() { return arrange; }
    @Override
