...
public class Write extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_status = false;
        RatingBar ratingBar=(RatingBar)findViewById(R.id.ratingBarInficator);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    String result = request.PhPtest(String.valueOf(title.getText()),String.valueOf(context.getText()),imgName,content_id,id,Rating);
                    if(result.equals("1")){
