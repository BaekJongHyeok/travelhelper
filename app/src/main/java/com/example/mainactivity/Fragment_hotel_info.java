...
public class Fragment_hotel_info extends Fragment {
    ...
    private static Fragment_hotel_info instance;
    public String arrage="A";
public boolean visible=false;
    public static synchronized  Fragment_hotel_info getInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        com.example.mainactivity.Fragment_hotel_info.MyAsyncTask myAsyncTask = new com.example.mainactivity.Fragment_hotel_info.MyAsyncTask();
        myAsyncTask.execute();
...
public void  search(){
    ...
    public class MyAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            arrage=((MainActivity)getActivity()).publicMethod4();
            searchString =((MainActivity)getActivity()).publicMethod();
            ...
            contypeid = getString(R.string.hotel_contypeid);
